...
public class ProductOrderly {
    ...
    private ExecutorService threadPoolExecutor = new ThreadPoolExecutor(10, 20, 10, TimeUnit.SECONDS, new ArrayBlockingQueue<>(1000000));
        ...
        try {
            for (int i = 0; i < 10; i++) {
                threadPoolExecutor.execute(() -> {
                    try {
                        MQUtil.sendMessage(topicName, msg);
